...
function getStatistics() {
    return array(
        ...
        "minecraft:brewingstand_interaction" =>         array("name" => "Interactions with Brewing Stand", "factor" => "", "symbol" => ""),
        ...
        "minecraft:crafting_table_interaction" =>       array("name" => "Interactions with Crafting Table", "factor" => "", "symbol" => ""),
        "minecraft:furnace_interaction" =>              array("name" => "Interactions with Furnace", "factor" => "", "symbol" => ""),
