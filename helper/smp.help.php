...
function getStatistics() {
    return array(
        ...
        "minecraft:inspect_dispenser" =>                array("name" => "Dispensers Searched", "factor" => "", "symbol" => ""),
        ...
        "minecraft:open_enderchest" =>                  array("name" => "Ender Chests Opened", "factor" => "", "symbol" => ""),
        "minecraft:fish_caught" =>                      array("name" => "Fish Caught", "factor" => "", "symbol" => ""),
        "minecraft:leave_game" =>                       array("name" => "Games Quit", "factor" => "", "symbol" => ""),
        "minecraft:inspect_hopper" =>                   array("name" => "Hoppers Searched", "factor" => "", "symbol" => ""),
        ...
        "minecraft:drop" =>                             array("name" => "Items Dropped", "factor" => "", "symbol" => ""),
        "minecraft:enchant_item" =>                     array("name" => "Items Enchanted", "factor" => "", "symbol" => ""),
        "minecraft:jump" =>                             array("name" => "Jumps", "factor" => "", "symbol" => ""),
        "minecraft:mob_kills" =>                        array("name" => "Mob Kills", "factor" => "", "symbol" => ""),
        "minecraft:play_record" =>                      array("name" => "Music Discs Played", "factor" => "", "symbol" => ""),
        "minecraft:play_noteblock" =>                   array("name" => "Note Blocks Played", "factor" => "", "symbol" => ""),
        "minecraft:tune_noteblock" =>                   array("name" => "Note Blocks Tuned", "factor" => "", "symbol" => ""),
        "minecraft:deaths" =>                           array("name" => "Number of Deaths", "factor" => "", "symbol" => ""),
        "minecraft:pot_flower" =>                       array("name" => "Plants Potted", "factor" => "", "symbol" => ""),
        ...
        "minecraft:open_shulker_box" =>                 array("name" => "Shulker Boxes Opened", "factor" => "", "symbol" => ""),
        "minecraft:sneak_time" =>                       array("name" => "Sneak Time", "factor" => "", "symbol" => ""),
        ...
        "minecraft:trigger_trapped_chest" =>            array("name" => "Trapped Chests Triggered", "factor" => "", "symbol" => ""),
